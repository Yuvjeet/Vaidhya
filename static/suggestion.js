            ...
            for (i = 0; i < arr.length; i++) {
              ...
              if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                ...
                /*execute a function when someone clicks on the item value (DIV element):*/
                    ...
                    const data =  this.getElementsByTagName("input")[0].value;
                    content = document.createTextNode(this.getElementsByTagName("input")[0].value);
                    ...
                    if(document.getElementById("predictions")) document.getElementById("predictions").style.display = "none"
